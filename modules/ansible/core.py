...
ROLE_DESCRIPTIONS = {
    ...
    "users": "Cree l'utilisateur de deploiement (sudo sans mot de passe) et depose sa cle SSH publique.",
...
def _build_vars(config):
    ...
    return {
        ...
        "deploy_user": config.get("deploy_user") or config.get("ssh_user") or "deploy",
